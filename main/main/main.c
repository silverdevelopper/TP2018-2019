...
int main(int argc, char *argv[])
{
     ...
     */
    /*
    argv[2]=malloc(strlen("invert"));
    strcpy(argv[2], "invert");
    argv[3]=malloc(strlen("/Users/mac/Desktop/ALGORTİMA ve ileri prog tp/main/main/man_binary.pgm"));
    argc=4;
    strcpy(argv[3], "/Users/mac/Desktop/ALGORTİMA ve ileri prog tp/main/main/man_ascii.pgm");
    */
    ...
    for (i = 2; i < argc; ++i) {
	    ...
	    if (strcmp(effect_name, "invert") == 0) {
             ...
             * ekrana yazdirin. */
	    // Alistirma 4
           int res= pgm_write("man_ascii.pgm.invert",pgm_info);
            if (res==1) {
